...
SmartDNS
`````
curl -sLo /tmp/sdns.sh https://raw.githubusercontent.com/opyzzzz/argox/refs/heads/main/smartdns.sh && bash /tmp/sdns.sh
`````
...
sb-musl安装
`````
wget -qO /tmp/sb-musl.sh https://raw.githubusercontent.com/opyzzzz/argox/refs/heads/main/singbox/1.13.21/sb-musl.sh && chmod +x /tmp/sb-musl.sh && bash /tmp/sb-musl.sh
`````
